/**
 * 博客列表配置（构建时原样拷贝到 dist/config/blog.js）
 * - 按语言键 en/ar 维护 filters 与 events
 * - 页面加载时根据 localStorage.language 挂到 window.Blog
 * - 详情正文见 public/markdown/{语言}/{fileName}.md
 */
const data = {
    en: {
        // 分类
        ...
        events: [
            ...
            },
            {
                ...
                image: '/config/images/blog-03.jpg',
...
// 按当前语言选取分支，供 Blog 页与 blobExample 详情页读取
